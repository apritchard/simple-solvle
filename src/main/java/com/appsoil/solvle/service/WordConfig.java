...
public enum WordConfig {
    ...
    OPTIMAL_MEAN_WITH_PARTITIONING_HARMONIC(WordCalculationConfig.OPTIMAL_MEAN_HARMONIC),
    OPTIMAL_MEAN_WITH_PARTITIONING_HARD_MODE(WordCalculationConfig.OPTIMAL_MEAN_HARD_MODE),
    OPTIMAL_MEAN_WITH_PARTITIONING_HARD_MODE_RUTBREAK(WordCalculationConfig.OPTIMAL_MEAN_HARD_MODE_RUTBREAK),
