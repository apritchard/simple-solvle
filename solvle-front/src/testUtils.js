...
export function renderWithContext(ui, contextOverrides = {}) {
    const defaultContext = {
        ...
        knownLetters: new Map(),
        unsureLetters: new Map(),
        solverOpen: false,
        ...
        onDelete: jest.fn(),
        onEnter: jest.fn(),
        addKnownLetter: jest.fn(),
        removeKnownLetter: jest.fn(),
        addUnsureLetter: jest.fn(),
        removeUnsureLetter: jest.fn(),
        addAvailableLetter: jest.fn(),
        removeAvailableLetter: jest.fn(),
